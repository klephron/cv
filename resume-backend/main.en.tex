...
\section{Projects}
    \resumeSubHeadingListStart
        ...
        {\href{https://github.com/IoT-MHWS}{\underline{\textbf{IoT World Simulation}}} $|$ \footnotesize\emph{C++, CMake, Conan, Python, gRPC, GTest, Protobuf, Docker, Git}}{May 2023 - June 2023}
        \resumeItemListStart
        ...
        \resumeProjectHeading
        {\href{https://github.com/zubrailx/buffer-lru}{\underline{\textbf{Interactive Buffer LRU}}} $|$ \footnotesize\emph{Verilog, Vivado IDE}}{April 2023}
        \resumeItemListStart
        ...
        \resumeProjectHeading
        {\href{https://github.com/zubrailx/academic-relational-db}{\underline{\textbf{Academic Relational DB}}} $|$ \footnotesize\emph{C/C++, Bison, Flex, Boost, gRPC, CTest, Protobuf, Cmake, Bash, Git}}{January 2023}
        \resumeItemListStart
        ...
        \resumeProjectHeading
        {\href{https://github.com/zubrailx/alu-cpu}{\underline{\textbf{ALU CPU}}} $|$ \footnotesize\emph{Python, Coverage, Mypy, Pylint, Pytest, CI/CD, Bash, Git}}{December 2022}
        \resumeItemListStart
...
\section{Experience}
  \resumeSubHeadingListStart
        ...
        \resumeExperienceHeading
          {\href{https://github.com/zubrailx/tinkoff-hack-2022}{\underline{\textbf{Tinkoff Invest Robot Contest}}} $|$ \footnotesize\emph{Backend Developer, DevOps}}{May 2022}
        \resumeItemListStart
        ...
        \resumeExperienceHeading
          {\href{https://github.com/zubrailx/ovision-hack-2022}{\underline{\textbf{Ovision Hack Dev Track}}} $|$ \footnotesize\emph{Frontend Developer }}{April 2022}
        \resumeItemListStart
