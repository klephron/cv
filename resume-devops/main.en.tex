...
\resumeSubHeadingListStart
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{Ansible, Terraform, KVM, Docker Swarm, Jenkins, Nginx, Consul, ELK Stack, RabbitMQ, MongoDB, Redis}
    \resumeItemListEnd
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{Ansible, Terraform, KVM, Kubernetes, Jenkins, SonarQube, Prometheus, Grafana, PostgreSQL}
    \resumeItemListEnd
  ...
  \resumeItemListStart
    \resumeItem{Docker, Kafka, ClickHouse, MQTT, Go, Python}
  \resumeItemListEnd
\resumeSubHeadingListEnd
\end{document}
