...
\section{Образование}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Магистратура Системное программное обеспечение}{5.00/5.00}
...
\resumeSubHeadingListStart
  \small{\item{
    \textbf{Технологии}{: Ansible, Docker, GitHub/GitLab Actions, Grafana, Jenkins, Kafka, KVM, Linux, MongoDB, Nginx, PostgreSQL, RabbitMQ, Redis, Prometheus, Terraform }
